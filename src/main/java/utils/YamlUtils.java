...
import exception.ConfigurationResolveException;
...
public class YamlUtils {
    ...
    public static <T> T parse(String yamlText, Class<T> clazz) throws ConfigurationResolveException {
    ...
    public static <T> T parse(InputStream in, Class<T> clazz) throws ConfigurationResolveException {
        if (in == null) {
            return null;
        }
